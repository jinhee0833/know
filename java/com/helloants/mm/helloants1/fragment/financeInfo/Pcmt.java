...
public class Pcmt extends Fragment implements AdapterView.OnItemClickListener  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_pcmt, container, false);
    ...
    private void initData() {
        try {
            final Thread iThread = new Thread() {
                ...
                public void run() {
                    try {
                        mContentList = ContentDB.INSTANCE.mPcmtList;
