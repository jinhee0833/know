 ...
 */
public class BsEachAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BsEachAdapter(Context context, ArrayList list, RecyclerView view) {
        mContext = context;
        mList = list;
        mRecyclerView = view;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if( holder instanceof IsHeaderViewHolder) {
            ...
            ((IsRecyclerViewHolder) holder).txtTime.setText(new SimpleDateFormat("yy-MM-dd E HH:mm").format(type.mDate));
